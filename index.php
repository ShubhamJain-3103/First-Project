...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="Coaching &raquo; Comments Feed"
    ...
    window._wpemojiSettings = {
        ...
        "svgExt": ".svg",
        "source": {
            "concatemoji": "https:\/\/extendthemes.com\/demos\/mesmerize-pro-coaching\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.2.5"
        }
    };
    ! function(a, b, c) {
        function d(a, b) {
    ...
    <link rel='stylesheet' id='companion-bundle-css'
        data-href='https://extendthemes.com/demos/mesmerize-pro-coaching/wp-content/plugins/mesmerize-companion/theme-data/mesmerize/assets/css/companion.bundle.min.css?ver=1.6.110'
        type='text/css' media='all' />
    <link rel='stylesheet' id='wp-block-library-css'
        href='wp-includes/css/dist/block-library/style.min6619.css?ver=5.2.5' type='text/css' media='all' />
    <link rel='stylesheet' id='contact-form-7-css'
        href='wp-content/plugins/contact-form-7/includes/css/styles58e0.css?ver=5.1.4' type='text/css' media='all' />
    <link rel='stylesheet' id='mesmerize-style-css' href='wp-content/themes/mesmerize-pro/style.min0196.css?ver=1.6.102'
        type='text/css' media='all' />
    ...
    #offcanvas_menu li.current-menu-item>a,
    #offcanvas_menu li.current_page_item>a {
        color: #CC4543 !important;
        border-left-color: #CC4543 !important;
    }
    ...
    .navigation-bar.homepage.coloured-nav #main_menu li.logo>a.text-logo,
    .navigation-bar.homepage.coloured-nav #main_menu li.logo>a.text-logo:hover,
    .navigation-bar.homepage a.text-logo,
    .navigation-bar.homepage #main_menu li.logo>a.text-logo,
    .navigation-bar.homepage #main_menu li.logo>a.text-logo:hover {
        color: #FFFFFF;
        font-family: Roboto, Helvetica, Arial, sans-serif;
        font-weight: 500;
        font-style: normal;
    ...
    <link rel='stylesheet' id='mesmerize-fonts-css'
        data-href='https://fonts.googleapis.com/css?family=Open+Sans%3A300%2C400%2C600%2C700%2C300%2C400%2C600%2C700%7CMuli%3A300%2C300italic%2C400%2C400italic%2C600%2C600italic%2C700%2C700italic%2C900%2C900italic%2C300%2C300italic%2C400%2C400italic%2C600%2C600italic%2C700%2C700italic%2C900%2C900italic%7CPlayfair+Display%3A400%2C400italic%2C700%2C700italic%2C400%2C400italic%2C700%2C700italic%7CRoboto%3A100%2C100italic%2C300%2C300italic%2Cregular%2C500%2C700%2C900%7CMartel%3A200%2C300%2Cregular%2C600%2C700%2C800%2C900&#038;subset=latin%2Clatin-ext'
        type='text/css' media='all' />
    <link rel='stylesheet' id='mesmerize-style-bundle-css'
        href='wp-content/themes/mesmerize-pro/pro/assets/css/theme.bundle.min0196.css?ver=1.6.102' type='text/css'
        media='all' />
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed5006.json?url=https%3A%2F%2Fextendthemes.com%2Fdemos%2Fmesmerize-pro-coaching%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embedb1d5?url=https%3A%2F%2Fextendthemes.com%2Fdemos%2Fmesmerize-pro-coaching%2F&amp;format=xml" />
...
<body
    class="home page-template page-template-page-templates page-template-homepage page-template-page-templateshomepage-php page page-id-4 custom-background overlap-first-section mesmerize-front-page mesmerize-content-no-padding ">
            ...
            <div class="navigation-wrapper white-logo fixed-dark-logo">
                <div class="row basis-auto">
                    <div class="logo_col col-xs col-sm-fit">
                        <a class="text-logo" data-type="group" data-dynamic-mod="true" href="index.php"><img
                                src="./images/Logopit_1571920426174.jpeg" class="rounded-circle" alt="" width="80"
                                height="70" style="border-radius: 50%;"></a>
                    </div>
                    <div class="main_menu_col col-xs">
                        <div id="mainmenu_container" class="row">
                            <ul id="main_menu" class="active-line-bottom main-menu dropdown-menu">
                                <li id="menu-item-53"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-4 current_page_item menu-item-53">
                                ...
                                <li id="menu-item-56"
                                    class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-56">
                                ...
                                <li id="menu-item-57"
                                    ...
                                    <a href="#courses" aria-current="page">Services</a>
                                </li>
                                ...
                                <li id="menu-item-83"
                                    ...
                                    <a href="#our-blog" aria-current="page">Our blog</a>
                                </li>
                                <li
                                    class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-56">
                                    <a href="StudentRegistration.php" aria-current="page">Register </a>
                                </li>
                                <li
                                    class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-56">
                                    <a href="LoginPage.php" aria-current="page">Login</a>
                                </li>
                        ...
                        <div id="offcanvas-wrapper" class="hide force-hide  offcanvas-right">
                            <div class="offcanvas-top">
                                <div class="logo-holder">
                                    <a class="text-logo" data-type="group" data-dynamic-mod="true" href="index.php">7
                                        WAVES</a>
                                </div>
                            </div>
    ...
    <div id="page" class="site">
        ...
        <div class="header-wrapper">
            <div class='header-homepage  color-overlay'
                style=' background-image:url(_http_/extendthemes.com/demos/mesmerize-pro-coaching/wp-content/uploads/sites/33/2018/08/background.jpg); background-color:#343A40; min-height:100vh'
                    ...
                    <div class="row header-description-row">
                        <div class="header-content header-content-left col-sm-12 col-xs-12">
                            <div class="align-holder left">
                                <h1 class="hero-title">If life doesn't <span
                                        style="font-weight: 500;color: rgb(204, 69, 67)">knock,</span> build <span
                                        style="font-weight: 500"> a door.</span></h1>
                                <p class="header-subtitle">If you think your life isn't fair, think again.</p>
                                <div data-dynamic-mod-container class="header-buttons-wrapper"><a
                                        class="button big color1 square" target="_self"
                                        href="StudentRegistration.php">Learn More</a><a
                                        class="button big color-white square outline" target="_self"
                                        href="index.php#courses">Search Service For you. </a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
it was commented -->
 ...
 -->
    ...
    <div data-label="About" data-id="content--1" data-export-id="content-17" data-category="content"
        class="content-17 content-section content-section-spacing content-relative" id="about"
        ...
        <div class="section-separator-top">
            <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1000 100"
                data-separator-name="tilt-flipped" class="section-separator-top">
        ...
        <div class="gridContainer">
            <div class="row middle-sm">
                <div class="col-sm-6 space-bottom-xs" data-type="column">
                    ...
                    <p class="">7 Waves is a platform that help people recognize their self worth and help them to aware
                        about their inner potential that lives within them. life is like a wave so take most of it. </p>
                    <a class="button color1 square" href="LoginPage.php" target="_self" data-cp-link="1"
                        data-icon="">LEARN MORE</a>
                </div>
    ...
    <div data-label="Cta" data-id="cta--1" data-export-id="cta-centered-bg-section" data-category="cta"
        data-section-ov="1"
        class="cta-centered-bg-section content-section content-section-spacing-medium white-text content-relative"
        data-parallax-depth="20" id="cta-1"
        style="background-color: rgb(255, 255, 255); background-image: url(_http_/extendthemes.com/demos/mesmerize-pro-coaching/wp-content/uploads/sites/33/2018/08/conference-2705706_1920-1.html); background-size: cover; background-position: center top;">
        <div class="section-separator-top">
            <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1000 100"
                data-separator-name="tilt-flipped" class="section-separator-top">
                <path id="path2" d="M 1000,0 H 0 v 100 z" class="svg-white-bg"></path>
        ...
        <div class="gridContainer">
            <div class="row text-center">
                <div data-type="column" class="">
                    <h2 class="">Don't be afraid to reinvent yourself</h2> <a class="button big color1 square"
                        href="index.php#about" target="_self" data-cp-link="1" data-icon="">GET STARTED TODAY</a>
                </div>
            </div>
        </div>
        <div class="section-separator-bottom">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none"
                data-separator-name="tilt" class="section-separator-top section-separator-bottom">
    ...
    <div data-label="Courses" data-id="features--1" data-export-id="features-16-card-bordered" data-category="features"
        class="features-16-card-bordered content-section content-section-spacing" id="courses"
        style="background-color: rgb(236, 236, 236); background-image: none;">
        <div class="gridContainer">
            <div class="row text-center">
            ...
            <div class="row spaced-cols" data-type="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/motivation.jpeg" alt="" title="meeting-83519_640">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Motivation</h4>
                            <p class="">Motivation plays an important role in one's life. We tell people to use
                                motivation as a tool to achieve great heights of success in their life.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/introspection.jpeg" alt=""
                            title="introspection.jpeg">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Introspection</h4>
                            <p>Analyzing and looking at your personality is called introspection. Here we teach you how
                                to meditate and understand your feeling so that you can understand yourself better.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/45F97165-0AE2-4C23-87A3-C7F1EB914F0D.jpeg" alt=""
                            title="work-2196609_640">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Career Consultant</h4>
                            <p class="">Wheather the person is new to the working world, or simply desires a change of
                                profession, the career counselor will be able to guide them in the best possible
                                direction in the career.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/76C5A09E-92C9-447D-B09E-960CCFC7FDF6.jpeg" alt=""
                            title="work-2196609_640">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Depression</h4>
                            <p class="">Depression is a common and serious medical illness that negatively affects how
                                you feel, the way you think and how you act. Fortunately, it is also treatable. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/3B79BE18-3FA2-4EBE-9043-CC5BBF3313F0.jpeg" alt=""
                            title="work-2196609_640">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Relationship</h4>
                            <p class="">Relationship is like a rose flower, you water it care for it and nurture it for
                                it to keep loving and blooming. Sometimes heart sees what is invisible to eyes </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/AEAAC01F-FD86-4CFA-A72C-826CFE96B664-1024x691.jpeg"
                            alt="" title="work-2196609_640">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Business Advisor</h4>
                            <p class="">Business coach clarify the vision of your business and how it will fit in,with
                                your personal goals. Business coach will assist and guide the owner in running a
                                business. They analyze company's financial and bussiness plans to advice them about
                                investment, marketing, and funding opportunity. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card no-padding bordered y-move"> <img class="face"
                            src="wp-content/uploads/sites/33/2018/08/9F571A1A-2961-42DB-9709-2D2BCDDC5BF5.jpeg" alt=""
                            title="work-2196609_640">
                        <div data-type="column" class="col-padding-small col-padding-small-xs description-container">
                            <h4 class="font-500">Personal</h4>
                            <p class="">Wheather the person is new to the working world, or simply desires a change of
                                profession, the career counselor will be able to guide them in the best possible
                                direction in the career. We at 7 Waves ensures that needy gains an understanding to
                                become better in career.</p>
                        </div>
                    </div>
                </div>
 ...
 <div  class="col-xs-12 col-sm-4 text-center "> <div  data-default="shadow-small" data-featured="shadow-large" data-type="column" class="card shadow-small"> <h3  class="font-300 upper">VIP</h3> <h3  class="h1">$50</h3> <p  data-default="color1" data-featured="color2" class="small color1">per month</p> <ul  class="unstyled checked decoration-color1 black text-center"><li >Lorem ipsum</li><li >Lorem</li><li >Lorem ipsum</li><li >Lorem ipsum</li></ul> <a  data-default="color1" data-featured="color2" class="button upper color1 square" href="#" target="_self" data-cp-link="1" data-icon="">Get Started</a></div> </div> -->
    ...
    <div data-label="Our blog" data-id="latest_news--1" data-export-id="blog-section-card" data-category="latest_news"
        class="blog-section content-section content-section-spacing content-relative" id="our-blog"
        style="background-color: rgb(236, 236, 236); background-image: none;">
        <div class="section-separator-top">
            <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1000 100"
                data-separator-name="tilt-flipped" class="section-separator-top">
        ...
        <div class="gridContainer">
            ...
            <div class="row">
                <div data-type="row" data-dynamic-columns="handled"
                    data-content-shortcode="mesmerize_latest_news item_class=&quot;card no-padding&quot;">
                        ...
                        <div id="post-100" class="col-sm-6 col-md-4 space-bottom space-bottom-xs">
                            <div class="post-content card no-padding">
                                <div class="post-thumbnail">
                                    <a class="post-list-item-thumb ">
                                        <img width="800" height="500"
                                            src="wp-content/uploads/sites/33/2018/08/man-3230661_1920-1.jpg"
                                            class="attachment-post-thumbnail size-post-thumbnail wp-post-image" /> </a>
                                </div>
                                <div class="col-padding col-padding-xs">
                                    ...
                                    <p>The constitutional commitment is the most profound and enabling feature of the
                                        Indian Republic. Let's celebrate the day of it's declaration with heart and
                                        soul.<br>

                                        HAPPY REPUBLIC DAY TO OUR FELLOW <br>
                                        Our ancestors gave us a glorious past and it's future is in our hand. We need to
                                        create it.....<br>
                                        This RepublicDay...<br>
                        ...
                        <div id="post-97" class="col-sm-6 col-md-4 space-bottom space-bottom-xs">
                            <div class="post-content card no-padding">
                                <div class="post-thumbnail">
                                    <a class="post-list-item-thumb ">
                                        <img width="800" height="500"
                                            src="wp-content/uploads/sites/33/2018/08/whatis7w.jpg"
                                            class="attachment-post-thumbnail size-post-thumbnail wp-post-image" /> </a>
                                </div>
                                <div class="col-padding col-padding-xs">
                                    <h3 class="post-title space-bottom-small">
                                    ...
                                    <p>The 7 of 7Waves are our 7 parameters which help you to classify, recognize and
                                        solve your problem efficiently. So, let's recognize your wave or waves and work
                                        on them together to let your waves of life propagate smoothly.
                                        The Wave of 7Waves is like a wave of life that has many ups and downs. All the
                                        joyful and happy moments are ups and all depressing and failures in life are
                                        downs but how much high you bounce after hitting the bottom describes what life
                                        is. Don't stick to bottom, make a progress and get ready to bounce back from new
                                        and old downs with 7Waves.</p>
                                ...
                                <div class="post-thumbnail">
                                    <a class="post-list-item-thumb ">
                                        <img width="800" height="533"
                                            src="wp-content/uploads/sites/33/2018/08/zi6q5fryGV4_Full-683x1024.jpg"
                                            class="attachment-post-thumbnail size-post-thumbnail wp-post-image" /> </a>
                                </div>
                                <div class="col-padding col-padding-xs">
                                    <h3 class="post-title space-bottom-small">
                                    ...
                                    <p>"NOTHING CAN DIM THE LIGHT WHICH SHINES FROM WITHIN."
                                        ...
                                        At some points in our life, we need to change the habits and lifestyle to gain
                                        more and more.

                                        When a change is brought forward and people don't like it can often lead to
                                        hate.

                                        But is it beneficial, is it leading you to your goal, is it worth? Think and
                                        apply. No matter what kind of challenges or painful situations you go through
                                        during the change, but if you reach down and deep within yourself, you'll find
                                        your inner strength.
            ...
            <div class="row">
                <div class="text-center"> <a class="button color1" href="LoginPage.php" target="_self">SEE ALL BLOG
                        POSTS</a></div>
            </div>
        </div>
    </div>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-58"><a href="index.php#pricing-1" aria-current="page">Pricing</a></li> -->
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div id="mc4wp_form_widget-3" class="widget widget_mc4wp_form_widget">
                            ...
                            <a href="https://instagram.com/official7waves?igshid=yzfg5tdez7s4"
            ...
            <div class="gridContainer">
                <div class="row middle-xs center-xs v-spacing">
                    <div>
                        ...
                        <p class="copyright" data-type="group">&copy; 2020 7 WAVES. Built by developers @ 7WAVES .</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type='text/javascript' defer="defer"
        src='wp-content/plugins/mesmerize-companion/theme-data/mesmerize/assets/js/companion.bundle.minaf6d.js?ver=1.6.110'>
    </script>
    <script type='text/javascript'>
    /* <![CDATA[ */
    var wpcf7 = {
        "apiSettings": {
            "root": "https:\/\/extendthemes.com\/demos\/mesmerize-pro-coaching\/wp-json\/contact-form-7\/v1",
    ...
    <script type='text/javascript' defer="defer"
        src='wp-content/themes/mesmerize-pro/pro/assets/js/theme.bundle.min0196.js?ver=1.6.102'></script>
    ...
    <script type='text/javascript' src='wp-content/plugins/mailchimp-for-wp/assets/js/forms-api.min62d0.js?ver=4.5.3'>
    </script>
    <!--[if lte IE 9]>
