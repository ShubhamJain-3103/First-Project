...
<main role="main">
  ...
  <div class="jumbotron">
    ...
    <input type="password" id="psw" name="password" placeholder="Type your password    " pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
     </div>
    </div><br>
